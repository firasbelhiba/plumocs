  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 mt-1">
        ...
        <Button onClick={V.focusSearch} variant="secondary" size="md">search for it instead</Button>
      </div>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 mt-1">
        ...
        <Button onClick={V.mock} data-msg="we've told the team — thank you ✿" variant="secondary" size="md">
          tell the team
        </Button>
      </div>
